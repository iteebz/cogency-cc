...
async def maybe_cull(conversation_id: str, user_id: str, msg_storage, sum_storage: SummaryStorage, llm, threshold: int) -> bool:
    ...
    try:
        ...
        if culled > 0:
            ...
            await sum_storage.save_summary(conversation_id, user_id, summary, culled, start_ts, cull_ts)
...
async def compact_context():
    ...
    culled = await maybe_cull(conv_id, "cogency", msg_storage, sum_storage, llm, config.compact_threshold)
